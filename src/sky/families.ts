...
const KEYS: Key[] = [
  ...
  { t: 7.0, aerosol: 2.6, haze: 0.28, hazeHeight: 600, skySat: 0.9, skyFlat: 0.25, sun: 1, ambient: 1, ev: 0, wb: [1.03, 1.0, 0.97], sat: 1.0, contrast: 1.0, lift: 0.005, cumulus: 0.3 },
  { t: 9.5, aerosol: 1.8, haze: 0.2, hazeHeight: 800, skySat: 0.92, skyFlat: 0.35, sun: 1, ambient: 1, ev: 0, wb: [1.0, 1.0, 1.0], sat: 1.0, contrast: 1.0, lift: 0, cumulus: 0.6 },
  { t: 11.5, aerosol: 1.2, haze: 0.1, hazeHeight: 1000, skySat: 0.94, skyFlat: 0.5, sun: 1, ambient: 1, ev: 0, wb: [1.0, 1.0, 1.0], sat: 1.0, contrast: 1.0, lift: 0, cumulus: 1 },
  { t: 16.0, aerosol: 1.3, haze: 0.1, hazeHeight: 1000, skySat: 0.94, skyFlat: 0.5, sun: 1, ambient: 1, ev: 0, wb: [1.0, 1.0, 1.0], sat: 1.0, contrast: 1.0, lift: 0, cumulus: 1 },
  { t: 18.5, aerosol: 1.6, haze: 0.16, hazeHeight: 900, skySat: 0.92, skyFlat: 0.35, sun: 1, ambient: 1, ev: 0, wb: [1.02, 1.0, 0.98], sat: 1.0, contrast: 1.0, lift: 0, cumulus: 0.75 },
