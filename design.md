...
| Petřín and Strahov, the Castle view (7964 to 7981, 8749 to 8759, 9092, 9631 to 9633) | 17 | 7 | St Vitus and the Castle across Malá Strana roofs; the ridge silhouette. |
| Petřín, overcast panoramas (9179 to 9202) | 12 | 5, 7 | Same viewpoints in soft light. The overcast end of the slider. |
| Petřín, rose garden, orchards, meadows (7885 to 7900, 8721 to 8748, 8760 to 8764, 9617 to 9630) | 13 | 5, 6 | **The season.** Roses, peonies, orchard paths, meadow grass, cumulus over the hill. |
...
| Vyšehrad from the river, railway bridge, Náplavka (8186 to 8273) | 3 | 1, 2 | Twin spires from the water; the iron railway bridge; the southern embankment. |
| Dancing House, Jiráskův bridge, the weirs (8111 to 8185, 8951) | 29 | 2, 3 | The glass tower with red trams; weir foam; Palacký bridge; Rašín embankment facades. |
...
| Malá Strana, streets, facades, St Nicholas (7982 to 7995, 8082 to 8083, 8541 to 8556, 8767 to 8797, 8813 to 8818, 8920 to 8942) | 28 | 8 | **Materials.** Red and ochre plaster, dormers, cobbles, lamps, window boxes; the dome and bell tower with trams. |
| Lesser Town towers, on Charles Bridge (7996 to 8003, 8584 to 8594, 8800 to 8801, 8881 to 8918) | 9 | 8, 9 | Bridge towers and gate, statues, tourists, the view along the bridge in overcast light. |
| Charles Bridge from the water, golden evening (8005 to 8035, 8559 to 8583, 8683 to 8715, 8845 to 8872, 9029 to 9057, 9515 to 9521, 9640 to 9643) | 52 | 9, 17 | **Hero landmark.** Arches, Old Town tower, Smetana museum, St Francis dome; pedal boats and swans; warm evening light on stone. |
| Kampa, Čertovka, the weir below Petřín (7840 to 7843, 8066 to 8069, 8709, 8802 to 8806, 8821 to 8826, 9203 to 9204, 9612 to 9614) | 5 | 10 | The mill channel, Kampa roofs, the weir with Petřín behind, ducks. |
...
| New Town, Wenceslas Square, trams (8618 to 8633, 8946 to 8949) | 5 | 15 | Pink and cream Art Nouveau facades, red trams. |
| Letná, the bridges, Štefánik bridge, lawns (9245 to 9314, 9325 to 9373, 9451 to 9500) | 46 | 16 | **All the bridges in one frame.** Late light on the river, big lawn trees, the Old Town skyline through leaves. |
...
| Blue hour, night (8655 to 8680, 9059 to 9062, 9527 to 9608) | 32 | 18 | **The end of the route.** Charles Bridge and the Castle lit, the penguins, the Dancing House at night. |
| Wallenstein garden, leaves, fruit, water lilies (9074 to 9178, 9223 to 9241, 9369) | 19 | palette only | Early summer detail: mock orange, wet leaves, green plums, water lilies, the peacock. |

The mockup page `mockup/plan.html` renders this table with every frame, the route, and the star markers. Use it as the browsable version of this section.

### 3.3 Hero frames

Hero frames are the frames the renders are tested against (see §12). Confirmed by the user on 2026-09-25 and stored in `data/hero.json`. The list can still be edited in `mockup/plan.html` and re-exported.
...
| 9204 | Petřín, overcast | Overcast grade |
| 8371, 8385 | Vyšehrad ramparts looking north | Red roofs, cumulus, cloud shadows |
...
| 8801 | Charles Bridge west end | Lesser Town towers |
| 8796 | Malostranské náměstí | St Nicholas, tram |
| 8158 | Rašín embankment | Dancing House, tram |
| 8216 | Náplavka looking south | Vyšehrad spires, railway bridge |
| 8812 | Mánes Bridge looking west | Castle across the water |
...
| 8725, 8729 | Petřín meadow and orchard | Season, greens |
...
| 9519, 9542 | Novotného lávka at blue hour and at night | Blue hour, city lights |
...
3. **Light and atmosphere.** Late May sun at 50°N; four light families present in the set (clear warm morning, cumulus midday, pastel overcast evening, blue hour into night); haze toward the horizon.
...
| Greens | Desaturated and cooled. Foliage reads olive to teal-green, never lime. See 8729, 9126. |
| Blues | Sky is a muted cyan-blue, lighter and greyer than a "real" sky. Deep blue only at blue hour (9519). |
...
2. Filmic tonemap with the shadow toe and highlight shoulder tuned to the tone curve row above.
...
4. Vignette, grain, tiny chromatic aberration at 16 mm only.
5. Anti-aliasing (TAA) after tonemapping.

Provide a runtime toggle (key G, developer builds only) that bypasses steps 3 and 4 so the grade can be judged. Comparison against photographs happens only in the offline tool `tools/compare.ts` (§12.1); the app itself never loads a photograph.
...
| Late afternoon and golden hour | 16:00 to 20:30 | Letná bridges (9486, 9492), Charles Bridge evening (8683 to 8715) | Lower, warmer sun from the west. Stone glows. Sky still cyan-grey. |
| Blue hour and night | 20:30 to 23:00 | 9515 to 9562, 9567 to 9608 | Deep blue sky, city lights warm, floodlit landmarks, water reflecting lights. |

Weather variant, independent of time: **overcast pastel** (8952 to 9026, 9179 to 9202, 8881 to 8918). Flat light, no shadows, colours go pastel, sky is a bright grey with texture. Rolled with 20% probability at session start, or forced from the UI.

### 5.4 Sun position

Latitude 50.087°N, longitude 14.42°E, date 31 May, CEST. Compute with a standard solar position algorithm. Anchor values for validation: sunrise about 04:58, solar noon about 13:04 at 61° elevation, sunset about 21:06. Azimuths: sunrise 52°, sunset 308°.
...
| Data | Source | Use |
|---|---|---|
| Building footprints, heights, levels, roof shape and colour where tagged | OpenStreetMap via Overpass, bbox 14.37 to 14.47 E, 50.05 to 50.11 N | Tier 2 and 3 buildings |
...
|---|---|---|
| Charles Bridge | 8559 to 8583, 8683 to 8715, 8845 to 8872 | 16 sandstone arches, 515 m, slight S-curve in plan, 30 statue silhouettes on the parapets (simplified, no faces), lamps. The deck is cobbled. |
| Old Town Bridge Tower | 8027, 8704, 9515 | Gothic tower with steep roof, four corner turrets, the arch over the bridge deck. |
| Lesser Town Bridge Towers | 7996 to 8003, 8801, 8903 to 8904 | Two unequal towers joined by a gate; the taller Gothic one with a steep roof, the shorter Romanesque one. |
...
| St Nicholas, Malá Strana | 8787 to 8797, 8928, 8942 | Copper dome and lantern, the bell tower, the long nave; the most important dome in the Petřín panoramas. |
| Castle and St Vitus | 7965 to 7981, 8749 to 8759, 9092 | The long palace front along the ridge, St Vitus with two west towers, the tall south tower, the flying buttresses of the choir. Massing must be right; detail can be low, it is always seen from over 500 m. |
| Petřín lookout tower | 7957, 8725 | 63.5 m lattice tower on the summit, with the funicular line and the Hunger Wall as context. |
| Vyšehrad | 8216, 8284 to 8403 | The neo-Gothic basilica with two spires on the rock, the brick ramparts, Leopold and Tábor gates, the rotunda, the cemetery walls. |
...
Districts built from OSM footprints with real roof forms, district material rules, and procedural detail. Districts: Malá Strana, Kampa, Old Town, Josefov, Hradčany (below the Castle), Vyšehrad and Podskalí, New Town along the river (Rašín, Masaryk, Smetana embankments), the Smíchov bank opposite Petřín, Wenceslas Square.
...
Sun below −6° brings on: warm sodium and LED window lights scattered across the core (not every window, about 25%), street lamps along embankments and bridges, floodlights on the Castle, St Vitus, Charles Bridge towers, Týn, National Theatre, Vyšehrad basilica, the Dancing House, the Rudolfinum, and the penguin sculptures on Kampa (9531). Water reflects the lights as broken vertical streaks. Sky keeps a deep blue until 22:30, then near black with a few stars. Stop 18 lands in the blue hour, not full night.
...
| 2 | Down the Vltava | 22 | 07:15 | 300, −2300, 220 | 60, −1750, 10 | wide | Descend along the river, railway bridge and Palacký bridge below, rowers |
| 3 | Dancing House | 44 | 08:10 | 330, −1500, 130 | 215, −1215, 30 | long → wide | Approach, half orbit at 100 m radius, a tram passes |
| 4 | National Theatre, Legion Bridge | 62 | 08:55 | 260, −900, 115 | 157, −600, 20 | wide | Pass the golden roof, cross the island, tram on the bridge |
| 5 | Petřín, the climb | 80 | 09:40 | −450, −720, 190 | −1173, −334, 90 | wide | Rise over orchards and meadows |
| 6 | Petřín, rose garden and tower | 98 | 10:25 | −1120, −640, 260 | −1137, −445, 60 | wide | Circle the tower; on the north side the panorama viewpoint of 7924 to 7944 |
| 7 | The Castle ridge | 118 | 11:15 | −1360, 150, 330 | −751, 489, 120 | long | Sweep along the ridge with St Vitus filling the long lens |
| 8 | Malá Strana roofs | 138 | 12:05 | −640, 440, 210 | −336, 11, 40 | wide | Drop over dormers and chimneys to the dome and the bridge towers |
| 9 | Charles Bridge, low pass | 158 | 12:55 | −430, −40, 62 | 164, −33, 30 | wide | One slow pass along the bridge at statue height, boats and swans below |
| 10 | Kampa, Čertovka | 178 | 13:45 | 60, −250, 90 | −243, −167, 10 | wide | Turn back over Kampa, the mill channel, the weir |
| 11 | Old Town Square, orbit | 196 | 14:30 | 560, −40, 150 | 808, 111, 60 | long | Rise to the Týn towers, begin an orbit |
| 12 | Old Town Square, orbit | 214 | 15:15 | 900, 240, 150 | 808, 111, 60 | long | Continue, clock tower in view |
| 13 | Old Town Square, orbit | 228 | 15:50 | 700, 340, 140 | 808, 111, 60 | wide | Complete the orbit, leave toward Josefov |
| 14 | Josefov to Mánes Bridge | 244 | 16:30 | 450, 520, 175 | 300, 800, 20 | wide | Rooftops down to the river, Castle across the water |
| 15 | Wenceslas Square | 264 | 17:20 | 1100, −640, 230 | 1344, −856, 40 | long | From above the museum end, looking down the square, trams |
| 16 | The bridges from Letná | 290 | 18:25 | 330, 960, 300 | 0, 0, 20 | long → wide | Wide and high, all the bridges in one frame, late light |
| 17 | Back down the river | 318 | 19:35 | 240, −1250, 260 | 458, −2446, 60 | wide | Golden hour along the embankments toward Vyšehrad |
| 18 | Vyšehrad, blue hour | 345 | 20:45 | 760, −2850, 380 | 458, −2446, 40 | wide | Arrive above the rock as the lights come on and hold |
...
data/                hero.json (starred frames), route.json, palette.json, landmarks.json
...
1. A viewpoint record: camera position, heading, tilt, lens (wide or long), clock time, weather preset. Authored once by hand in the offline tool by lining the render up with the photograph, then saved to `data/viewpoints.json`.
...
| M1 | The look: sky model, four light families, clouds with shadows, haze, the Classic Negative grade v1, the two lenses | Hero frames 9369 (sky) and 8371 (cumulus over Vyšehrad blocks) pass the light mood question with roofs still as coloured blocks |
| M2 | Roofs and materials: Tier 2 districts with roof forms, dormers, chimneys, palette, facades, streets | Petřín panorama hero frames (7924, 7940, 7944) and Vyšehrad (8385) pass all three questions with landmarks still as boxes |
| M3 | Tier 1 landmarks, first six: Charles Bridge and its three towers, Týn, St Nicholas, the Castle massing, Petřín tower, Vyšehrad | Hero frames 8704, 8607, 8796, 8753, 8216 pass |
| M4 | Remaining Tier 1 landmarks and bridges, the weirs, islands, night lighting | 8158, 8812, 8490, 9486, 9519, 9542 pass |
| M5 | Vegetation and the season: species, orchards, rose garden, meadows, grading of greens | 8725, 8729, 8722 pass; the Petřín climb reads as gardens |
...
- The Castle is backdrop, modelled for massing, never a stop.
